...
const (
	FinalizerString = "finalizers.backup.services.k8s.aws/BackupPlan"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("backupplans")
