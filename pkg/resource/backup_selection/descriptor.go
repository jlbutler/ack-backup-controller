...
const (
	FinalizerString = "finalizers.backup.services.k8s.aws/BackupSelection"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("backupselections")
	GroupKind            = metav1.GroupKind{
		Group: "backup.services.k8s.aws",
...
func (d *resourceDescriptor) EmptyRuntimeObject() rtclient.Object {
	return &svcapitypes.BackupSelection{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.BackupSelection),
	}
}
