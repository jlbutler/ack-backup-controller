...
const (
	FinalizerString = "finalizers.backup.services.k8s.aws/BackupVault"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("backupvaults")
...
func (d *resourceDescriptor) EmptyRuntimeObject() rtclient.Object {
	return &svcapitypes.BackupVault{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.BackupVault),
	}
}
